        ...
        def buildDict(bus_timing):
            ...
            bus_dict = {
                ...
                "attributes": {
                    ...
                    "type": bus_type,
                    "load": bus_load,  # Added this line to include the Load attribute
                },
                "state": bus_state,
            }
                        ...
                        if idx is not None:
                            ...
                            sensors.append(
                                create_bus_sensor(
                                    ...
                                    bus["Operator"],
                                    bus["NextBus"]["Type"],
                                    bus["NextBus"]["Load"],  # Pass Load here
                                )
                            )
                            ...
                            sensors.append(
                                create_bus_sensor(
                                    ...
                                    bus["Operator"],
                                    bus["NextBus2"]["Type"],
                                    bus["NextBus2"]["Load"],  # Pass Load here
                                )
                            )
                            ...
                            sensors.append(
                                create_bus_sensor(
                                    ...
                                    bus["Operator"],
                                    bus["NextBus3"]["Type"],
                                    bus["NextBus3"]["Load"],  # Pass Load here
                                )
                            )
                        else:
                            """Create entity for 1st timing."""
